...
R is the original program for using the R programming language. When we install R, we are installing two things: (1) the R programming language, and (2) and the program that enables us to run and save our code, otherwise known as the Graphical User Interface (GUI).
