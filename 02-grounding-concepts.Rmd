# Installation and Grounding Concepts

The first thing we will do is install the R and R-Studio programs. 

## Installing R
To install R, you will need to visit the Comprehensive R Archive Network website, which can be found here <a href="https://cran.r-project.org/" target="_blank">(https://cran.r-project.org/)</a>. You can right click on this link and select <i>open in new tab</i>.
...
After downloading and installing R, open the program. It should look like this. This windows versision is on the left and the Mac version is on the right.
```{r echo=FALSE, out.width='100%'}
