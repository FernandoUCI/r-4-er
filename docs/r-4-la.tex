...
\texttt{R-Studio} also runs the R programming language. However, it has several features that make is easier to code in R.
...
Watch: How do download R-Studio
...
\includegraphics{r-4-la_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{r-4-la_files/figure-latex/unnamed-chunk-27-1.pdf}
