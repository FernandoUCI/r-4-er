...
\hypertarget{more-workflow-basics}{%
\chapter{More Workflow Basics}\label{more-workflow-basics}}

\hypertarget{creating-code-chunks}{%
\section{Creating Code Chunks}\label{creating-code-chunks}}
...
\section{Creating Comments}\label{creating-comments}}
...
\section{Commenting out multiple lines of code}\label{commenting-out-multiple-lines-of-code}}
...
\section{using read.csv() to import data}\label{using-read.csv-to-import-data}}
...
\section{Types and Classes}\label{types-and-classes}}
...
\section{using str() to examine data structure}\label{using-str-to-examine-data-structure}}
...
\section{\texorpdfstring{use the \texttt{View()} function actually look at your data}{use the View() function actually look at your data}}\label{use-the-view-function-actually-look-at-your-data}}
...
\section{\texorpdfstring{Using \texttt{summary()} to examine data}{Using summary() to examine data}}\label{using-summary-to-examine-data}}
...
\section{\texorpdfstring{Using \texttt{table()} to examine raw counts}{Using table() to examine raw counts}}\label{using-table-to-examine-raw-counts}}
...
\chapter{Creating a Histogram}\label{creating-a-histogram}}

\hypertarget{using-ggplot-to-creat-a-histogram-of-hsgpa}{%
\section{Using ggplot to creat a histogram of hsgpa}\label{using-ggplot-to-creat-a-histogram-of-hsgpa}}
...
\includegraphics{r-4-la_files/figure-latex/unnamed-chunk-36-1.pdf}

\hypertarget{inspecting-data-1}{%
\chapter{Inspecting Data}\label{inspecting-data-1}}
